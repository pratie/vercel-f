  ...
  return (
    <div className="mt-6 sm:mt-12 bg-gradient-to-br from-[hsl(var(--secondary))] to-white rounded-xl sm:rounded-2xl p-5 sm:p-8 mx-4 sm:mx-auto max-w-2xl shadow-sm border border-[hsl(var(--primary))]/10">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-5 sm:mb-6 text-center">
        ...
        <span className="text-[15px] sm:text-lg font-semibold text-gray-900">Want a custom feature built just for you? 🚀</span>
      </div>

      <div className="max-w-xl mx-auto">
        <p className="text-[15px] leading-relaxed sm:text-base text-gray-600 mb-4 sm:mb-6 text-center">
          I'm an indie hacker building this tool and I'm obsessed with your success. Need a <span className="text-[hsl(var(--primary))] font-medium">custom feature</span> or unique integration?
          Send me an email - let's build the perfect lead machine together!
        </p>
        ...
        <div className="flex justify-center mb-6 sm:mb-8">
          <div className="text-[13px] leading-relaxed sm:text-sm italic text-gray-600 max-w-[280px] sm:max-w-md text-center px-4 py-2.5 rounded-lg bg-white/50 border border-[hsl(var(--primary))]/10">
            ✨ Your feedback directly shapes our roadmap. I reply to every single email! ✨
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center">
        <button
          className="group w-full sm:w-auto flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--accent))] hover:from-[hsl(var(--primary))] hover:to-[hsl(var(--primary))] text-white px-5 sm:px-8 py-3 sm:py-3.5 rounded-full shadow-md hover:shadow-lg transition-[background-color,box-shadow] duration-200 max-w-[320px] sm:max-w-[360px]"
