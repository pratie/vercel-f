...
export default function ChatWidget() {
  ...
  // Kept off the landing page and the /explore funnel. It floated over the
  // hero, was the only thing on the page not in the brand palette, and was
  // surfacing a configuration error to first-time visitors. On /explore it
  // sat on top of the fixed offer bar. It still loads on the signed-in app,
